...
export const PRODUCT_CATEGORIES: readonly CategoryMeta[] = [
  ...
  { id: "leather-industry",                     title: "Leather Industry",                        icon: "👜", bg: "#FCE7F3", text: "#9D174D",
    subCategories: ["Leather processing", "Shoes & footwear", "Bags, belts & wallets"] },
  { id: "petroleum-energy-manufacturing",       title: "Petroleum & Energy-Based Manufacturing",  icon: "🛢️", bg: "#FFF1E6", text: "#9A3412",
  ...
  { id: "printing-publishing",                  title: "Printing & Publishing",                   icon: "🖨️", bg: "#EEF2FF", text: "#4338CA",
    subCategories: ["Books & newspapers", "Labels & stickers", "Packaging printing"] },
  { id: "toys-sports-goods",                    title: "Toys & Sports Goods Manufacturing",       icon: "🧸", bg: "#FFE4E6", text: "#BE123C",
  ...
  { id: "finished-goods", title: "Finished Goods",     icon: "📦", bg: "#F1F5F9", text: "#334155" },
  { id: "components",     title: "Components & Parts", icon: "🔩", bg: "#F1F5F9", text: "#334155" },
  { id: "raw-materials",  title: "Raw Materials",       icon: "🧱", bg: "#F1F5F9", text: "#334155" },
  { id: "machinery",      title: "Machinery & Equipment", icon: "⚙️", bg: "#F1F5F9", text: "#334155" },
  { id: "packaging",      title: "Packaging",           icon: "📦", bg: "#F1F5F9", text: "#334155" },
  { id: "services",       title: "Services",            icon: "🛠️", bg: "#F1F5F9", text: "#334155" },
  { id: "other",          title: "Other",                icon: "🏷️", bg: "#F1F5F9", text: "#334155" },
] as const;
