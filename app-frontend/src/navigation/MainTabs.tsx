...
const placeholderStyles = StyleSheet.create({
  ...
  content: { alignItems: "center", gap: scale(12) },
  icon: { fontSize: moderateScale(64), marginBottom: scale(8) },
  title: { fontSize: moderateScale(28), fontWeight: "800" },
  subtitle: { fontSize: moderateScale(16), fontWeight: "600" },
  badge: { marginTop: scale(16), paddingHorizontal: scale(16), paddingVertical: scale(8), borderRadius: scale(20), borderWidth: 1 },
...
const styles = StyleSheet.create({
  ...
  tabButton: { flex: 1, alignItems: "center", justifyContent: "center", paddingVertical: scale(4) },
  activeTabContainer: { alignItems: "center", justifyContent: "center", gap: scale(4) },
  inactiveTabContainer: { alignItems: "center", justifyContent: "center", gap: scale(4) },
  activeTabGlow: {
    width: scale(48),
    height: scale(48),
    alignItems: "center",
  ...
  inactiveGradientBorder: { width: scale(46), height: scale(46), padding: 1.5, alignItems: "center", justifyContent: "center" },
  inactiveIconInner: { width: scale(43), height: scale(43), alignItems: "center", justifyContent: "center" },
  tabIcon: { fontSize: moderateScale(22) },
  tabIconInactive: { fontSize: moderateScale(20), opacity: 0.7 },
  tabLabel: { fontSize: moderateScale(12), fontWeight: "600", textShadowColor: "rgba(0, 0, 0, 0.75)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 },
  tabLabelActive: { fontSize: moderateScale(12), fontWeight: "700", textShadowColor: "rgba(0, 0, 0, 0.75)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 },
  adminTabIconWrap: {
    position: "relative",
  },
  adminUnreadBadge: {
  ...
  userTabIcon: { fontSize: moderateScale(20) },
  userTabIconInactive: { fontSize: moderateScale(18), opacity: 0.7 },
  userTabLabelCommon: { fontSize: moderateScale(13), fontWeight: "700", letterSpacing: 0.2, textAlign: "center", textShadowColor: "rgba(0, 0, 0, 0.75)", textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 },
  footerIcon: { width: scale(22), height: scale(22) },
  ...
  modalTitle: { fontSize: moderateScale(16), fontWeight: "800" },
});
