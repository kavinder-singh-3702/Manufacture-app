...
export const ProfileScreen = () => {
  ...
  const handleSaveIdentity = () => {
    // Phone is intentionally NOT in the payload — the field is read-only
    // in the editor. To change phone, the user has to contact support
    // (or sign out and use the dedicated AddMobileNumber flow if they
    // signed in via social auth without a phone yet).
