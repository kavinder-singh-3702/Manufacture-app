...
export const metadata: Metadata = (() => {
  ...
  return {
    ...
    description: `List products, receive RFQs, and manage compliance, inventory, and GST accounting ${role.audienceLabel} on ARVANN.`,
  ...
  return (
    <>
      ...
      <RolePageTemplate
        ...
        title={`${role.title} — Sell Directly to Verified Buyers`}
        intro={role.intro}
