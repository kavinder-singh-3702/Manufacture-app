...
export const metadata: Metadata = (() => {
  ...
  return {
    ...
    description: `List products, respond to RFQs, and reach buyers actively sourcing by category and industry ${role.audienceLabel} on ARVANN.`,
  ...
  return (
    <>
      ...
      <RolePageTemplate
        ...
        title="Suppliers — Reach Buyers Sourcing by Industry"
        intro={role.intro}
