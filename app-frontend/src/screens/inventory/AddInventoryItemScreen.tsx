      ...
      >
        ...
        >
          ...
          <InputField
            ...
            onChangeText={(text) => updateField("minStockLevel", parseInt(text) || 0)}
            keyboardType="numeric"
          ...
          <View style={styles.row}>
            <View style={{ flex: 1, marginRight: spacing.sm }}>
              <InputField
                ...
                onChangeText={(text) => updateField("costPrice", parseFloat(text) || 0)}
            ...
            <View style={{ flex: 1, marginLeft: spacing.sm }}>
              <InputField
                ...
                onChangeText={(text) => updateField("sellingPrice", parseFloat(text) || 0)}
                keyboardType="decimal-pad"
              />
            </View>
          </View>
